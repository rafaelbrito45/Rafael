    ...
    <html lang="en" className={inter.className}>
      ...
      <body className="bg-[#7F7FD5] bg-app">
        <div className="z-10 relative h-screen lg:p-20 sm:py-5 flex items-center justify-center">
          <div className="bg-[#232135] overflow-hidden  overflow-y-auto border border-[#72707D] w-full max-w-[1480px] aspect-video shadow-md shadow-black/20 rounded-lg grid grid-rows-layout h-full">
            <OpenFilesProvider>
              <Header />

              <div className="grid lg:grid-cols-editor sm:grid-rows-editor max-h-full">
                <Menu />
                <Explorer />
